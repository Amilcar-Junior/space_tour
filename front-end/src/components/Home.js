      ...
      <section className="home">
        <div className="overlay p-10">
          ...
          <article>
            ...
            <Link className="bg-white text-gray-900 font-bold uppercase text-2xl w-40 h-40 rounded-full shadow xl:h-52 xl:w-52 xl:text-4xl animate-pulse mt-10 md:mt-0" to={`${process.env.PUBLIC_URL}/auth/login`} >Sign in</Link>
            </button>
          </article>
        </div>
      </section>
